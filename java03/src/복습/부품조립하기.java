...
public class 부품조립하기 {
	...
	public static void main(String[] args) {
		// 1. 자주써서  RAM에 언제든 사용 할 수 있도록 준비되어 있음
		//	     망치
		//	     부품명.기능()
		...
		f.add(l); //f라는 부품위에 조립해서 올려 놓아라.!
		//JtextField를 add 해 주세요.
		f.add(text);
		f.add(b);
...
10:50
package 복습;import java.awt.Color;
import java.awt.FlowLayout;
import java.awt.Font;import javax.swing.JButton;
import javax.swing.JFrame;
import javax.swing.JLabel;
import javax.swing.JTextField;public class 부품조립하기 {	public static void main(String[] args) {
...
//    벽돌 b1 = new 벽돌();
//    벽돌 b2 = new 벽돌();
//    벽돌 b3 = new 벽돌();		JFrame f = new JFrame();
f.setSize(400, 300);
