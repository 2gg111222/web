...
import javax.swing.JTextField;
	...
	public class 부품만들기1 {	
		...
		//text3.setText("로그인 결과"); 글자로 로그인 결과처리
		
		//글자 넣는 빈칸을 만드는 법
		//JTextField 변수명 = new JTextField(글자수 제한 숫자로 넣는다.);
		JTextField input1 = new JTextField(10); //글자 쓰는 란의 크기
		...
		//글자 크기 글씨체 같은 스타일을 설정 가능( 글씨체, ,글자크기,)
		...
		//text3.setForeground(Color.green); //버튼의 위색, 글자색
		
		//1.jpg 2.jpg같이 파일명을 쓰면  java02프로젝트 바로 아래 있는 것으로 인식!
